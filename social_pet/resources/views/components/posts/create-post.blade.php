...
<div id="post-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div class="p-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <button onclick="document.getElementById('post-modal').classList.add('hidden')" class="text-gray-400 hover:text-gray-600">
        ...
        <div class="p-4">
            <textarea placeholder="What's your pet doing?" class="w-full p-3 border rounded-lg focus:ring-2 focus:ring-social-teal focus:border-transparent" rows="4"></textarea>
            <div class="mt-4 flex justify-end">
                <button class="bg-social-teal text-white px-6 py-2 rounded-lg hover:bg-social-teal-dark transition">
                    Post
                </button>
            </div>
        </div>
