    ...
    Route::middleware(['auth'])->group(function () {
        ...
        [ProfileController::class, 'actualizarUbicacion']
    ...
    Route::post(
        ...
        [ProfileController::class, 'desactivarUbicacion']

    )->name('ubicacion.desactivar');
    ...
    Route::get('/messages', [MessageController::class, 'index'])
        ...
        '/messages/adopcion/start/{userId}/{adopcionId}',

        [MessageController::class, 'startAdopcion']

    )->name('messages.startAdopcion');

    Route::get('/messages/adopciones',

        [MessageController::class, 'adopciones'])

        ->name('messages.adopciones');
        Route::get(

        '/messages/marketplace',

        [MessageController::class, 'marketplace']

    )->name('messages.marketplace');

    Route::post(

        '/messages/marketplace/start/{userId}/{productoId}',

        [MessageController::class, 'startMarketplace']

    )->name('messages.startMarketplace');
    ...
    Route::prefix('historias')
        ...
        ->group(function () {
            ...
            Route::get(
                ...
                [HistoriaController::class, 'crear']
            ...
            Route::post(
                ...
                [HistoriaController::class, 'editor']
            ...
            Route::post(
                ...
                [HistoriaController::class, 'guardarFinal']
        ...
        [HistoriaController::class, 'ver']

    )->name('ver');
    Route::post(
    '/historias-destacadas',
    [HistoriaDestacadaController::class, 'store']
)->name('destacadas.store');

Route::get(
    '/historias-destacadas/{destacada}',
    [HistoriaDestacadaController::class, 'show']
)->name('destacadas.show');

Route::delete(
    '/historias-destacadas/{destacada}',
    [HistoriaDestacadaController::class, 'destroy']
)->name('destacadas.destroy');
Route::get(

    '/seleccionar-destacadas',

    [HistoriaController::class, 'seleccionarDestacadas']

)->name('destacadas.seleccionar');
...
Route::post(
    ...
    Route::get('/usuarios/buscar', [UserProfileController::class, 'buscar'])
    ...
    Route::middleware(['auth'])
        ...
        ->group(function () {
            ...
            Route::get('/{id}/edit', [MarketplaceController::class, 'edit'])
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::post('/adopciones', [AdopcionController::class, 'store'])
            ...
            Route::patch('/adopciones/{id}/adoptada',
        [AdopcionController::class, 'marcarAdoptada'])
        ->name('adopciones.adoptada');

    Route::patch('/adopciones/{id}/cancelar',
        [AdopcionController::class, 'cancelar'])
        ->name('adopciones.cancelar');
        Route::get(
        '/adopciones/{id}/solicitar',
        [SolicitudAdopcionController::class, 'create']
    )->name('adopciones.solicitar');
    Route::get(

        '/adopciones/solicitudes',

        [SolicitudAdopcionController::class, 'misSolicitudes']

    )->name('adopciones.solicitudes');
    Route::patch(
        '/solicitudes/{id}/aprobar',
        [SolicitudAdopcionController::class, 'aprobar']
    )->name('adopciones.aprobarSolicitud');

    Route::patch(
        '/solicitudes/{id}/rechazar',
        [SolicitudAdopcionController::class, 'rechazar']
    )->name('adopciones.rechazarSolicitud');   

    Route::post(
        '/adopciones/{id}/solicitar',
        [SolicitudAdopcionController::class, 'store']
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::post('/comunidades/{cod_com}/salir', [ComunidadController::class, 'salir'])
        ->name('comunidades.salir');

    Route::get('/comunidades/{cod_com}', [ComunidadController::class, 'show'])
        ->name('comunidades.show');

        Route::post('/comunidades/{cod_com}/publicar', [ComunidadController::class, 'publicar'])
        ->name('comunidades.publicar');

    Route::post('/publicaciones/{id}/like', [ComunidadController::class, 'like'])
        ->name('comunidades.like');

    Route::post('/publicaciones/{id}/comentar', [ComunidadController::class, 'comentar'])
        ->name('comunidades.comentar');
