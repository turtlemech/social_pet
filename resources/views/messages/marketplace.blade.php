...
<p class="text-sm text-gray-500 mt-1">
    ...
    Conversaciones relacionadas con compra y venta de productos
        ...
        🛒 Marketplace
            ...
            <div class="p-4 border-b border-gray-100">
                ...
                <div class="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Buscar conversación de marketplace..."
...
<div class="text-center py-10">
    ...
    <h3 class="font-bold text-gray-700">
        Sin conversaciones de marketplace
    </h3>

    <p class="text-gray-500 text-sm mt-2">
        Cuando contactes vendedores o compradores aparecerán aquí.
    </p>
...
@endif
    ...
    🛒 Conversaciones de Marketplace

</h2>
<p class="text-gray-500 text-lg leading-relaxed">
Aquí aparecerán las conversaciones relacionadas con productos del Marketplace.
</p>
