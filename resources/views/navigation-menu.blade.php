...
>
        ...
        @php
            ...
            $unreadNotifications = \App\Models\Notificacion::where('usuario_id', auth()->id())
                ->where('lei_not', false)
                ->count();
    ...
    >
        ...
        <!-- FILTROS -->
        <div class="px-6 py-4 flex gap-3 overflow-x-auto border-b border-gray-100">
    ...
    <button
        @click="filtro = 'comentario'"
        :class="filtro === 'comentario'
            ? 'bg-black text-white'
            : 'bg-gray-100 text-gray-700'"
        class="px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition"
    >
    ...
    >
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            @php
                ...
                $notifications = \App\Models\Notificacion::where('usuario_id', auth()->id())
                    ->latest()
                    ->take(30)
                    ->get();
...
>
    ...
    <a
        ...
        href="{{ $notification->url_not ?? '#' }}"

        class="flex gap-4 px-6 py-4 hover:bg-gray-50 transition border-b border-gray-100"
    ...
    >
                ...
                <div class="flex-shrink-0">
                    ...
                    <div class="w-14 h-14 rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 text-white flex items-center justify-center font-bold text-lg">
