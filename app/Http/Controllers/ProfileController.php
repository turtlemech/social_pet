    ...
    public function myPets()
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'app_us.required' => 'El apellido paterno es obligatorio', // ← corregido
            'app_us.min' => 'El apellido paterno debe tener al menos 2 caracteres', // ← corregido
            'apm_us.required' => 'El apellido materno es obligatorio', // ← agregado
            'apm_us.min' => 'El apellido materno debe tener al menos 2 caracteres', // ← agregado
        ...
        $user->app_us = $request->app_us;
        $user->apm_us = $request->apm_us;
    ...
    public function destroy(Request $request)
    {
        try {
            ...
            $user->est_us = 0; // o 'inactivo' según tu BD
            $user->save();
