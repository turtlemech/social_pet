    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-gray-600">
                Utiliza este chat para coordinar entrevistas, visitas y entrega de la mascota.
            </p>
...
<div class="mx-6 mt-4">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
        ...
        <img
            src="{{ asset('storage/' . $adopcionInfo->fot_mas) }}"
        ...
        <div>
            ...
            <h3 class="font-bold text-lg text-gray-800">
                {{ $adopcionInfo->nom_mas }}
            </h3>
            <p class="text-sm text-gray-600 mt-2">

    {{ $adopcionInfo->des_ado }}
                    ...
                    <div class="h-full flex items-center justify-center">
                        ...
                        <div class="text-center">
                            ...
                            <h2 class="text-2xl font-bold text-gray-700">
                                Sin mensajes de adopción todavía
                            </h2>
