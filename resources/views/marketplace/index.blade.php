        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
            ...
            <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    <button onclick="filterByCategory('alimento')" class="filter-btn px-4 py-2 rounded-lg text-sm font-semibold bg-gray-100 text-gray-600 hover:bg-[#0d9488] hover:text-white transition" data-cat="alimento">🍖 Alimento</button>
                    <button onclick="filterByCategory('juguete')" class="filter-btn px-4 py-2 rounded-lg text-sm font-semibold bg-gray-100 text-gray-600 hover:bg-[#0d9488] hover:text-white transition" data-cat="juguete">🧸 Juguete</button>
                    <button onclick="filterByCategory('accesorio')" class="filter-btn px-4 py-2 rounded-lg text-sm font-semibold bg-gray-100 text-gray-600 hover:bg-[#0d9488] hover:text-white transition" data-cat="accesorio">🎀 Accesorio</button>
                    <button onclick="filterByCategory('ropa')" class="filter-btn px-4 py-2 rounded-lg text-sm font-semibold bg-gray-100 text-gray-600 hover:bg-[#0d9488] hover:text-white transition" data-cat="ropa">👕 Ropa</button>
