    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <span class="font-bold text-teal-700 text-lg">SocialPet</span>
            </div>
            <div class="flex items-center space-x-4">
                <a href="{{ route('feed') }}" class="text-gray-500 hover:text-teal-600">
                    <i class="fas fa-home text-xl"></i>
                </a>
                <a href="{{ route('comunidades.index') }}" class="text-teal-600">
        ...
        <aside class="hidden lg:block w-64 flex-shrink-0">
            <div class="bg-white rounded-2xl shadow-sm p-4 mb-4">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('amistades.amigos') }}" class="flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-50 text-gray-600">
